...
<html lang="en">
	<head>
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/css/ace-part2.css" class="ace-main-stylesheet" />
		<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/static/assets/js/ace-extra.js"></script>
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/static/components/bootstrap/dist/js/bootstrap.js"></script>

		<!-- page specific plugin scripts -->

		<!-- ace scripts -->
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.scroller.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.colorpicker.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.fileinput.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.typeahead.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.wysiwyg.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.spinner.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.treeview.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.wizard.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.aside.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.basics.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.scrolltop.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.ajax-content.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.touch-drag.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.sidebar.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.sidebar-scroll-1.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.submenu-hover.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.widget-box.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.settings.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.settings-rtl.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.settings-skin.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.widget-on-reload.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.searchbox-autocomplete.js"></script>
		...
		<script src="${pageContext.request.contextPath}/static/assets/js/src/elements.onpage-help.js"></script>
		<script src="${pageContext.request.contextPath}/static/assets/js/src/ace.onpage-help.js"></script>
